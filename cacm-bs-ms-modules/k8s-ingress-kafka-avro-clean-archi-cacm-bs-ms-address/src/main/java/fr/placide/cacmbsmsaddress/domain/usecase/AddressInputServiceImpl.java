...
public class AddressInputServiceImpl implements AddressInputService {
    ...
    public Address createAddress(AddressDto addressDto) throws AddressAlreadyExistsException, AddressFieldsInvalidException {
        ...
        return addressOutputService.createAddress(Mapper.map(produced));
    }
    ...
    public Address updateAddress(AddressDto payload, String addressId) throws AddressNotFoundException,
        ...
        return addressOutputService.updateAddress(Mapper.map(avro));
    }
    ...
    public String deleteAddress(String addressId) throws AddressNotFoundException, RemoteCustomerAPIException, AddressAssignedCustomerException {
        Address address = getAddressById(addressId);
        Customer customer = remoteCustomerService.getRemoteCustomer(addressId);
        if(customer!=null){
        ...
        return addressOutputService.deleteAddress(produced.getAddressId());
    }
    @Override
